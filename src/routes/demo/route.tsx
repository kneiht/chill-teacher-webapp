  ...
  const menuItems: MenuProps['items'] = [
    {
      ...
      label: <Link to="/demo/dashboard">{t('Dashboard')}</Link>,
    },
    {
      key: '/students',
      icon: <UserOutlined />,
      label: <Link to="/demo/students">{t('Students')}</Link>,
    },
    {
      key: '/teachers',
      icon: <TeamOutlined />,
      label: <Link to="/demo/teachers">{t('Teachers')}</Link>,
    },
    {
      key: '/classes',
      icon: <BookOutlined />,
      label: <Link to="/demo/classes">{t('Classes')}</Link>,
    },
    {
      key: '/classroom',
      icon: <ReadOutlined />,
      label: <Link to="/demo/classroom">{t('Classroom')}</Link>,
    },
    {
      key: '/attendance',
      icon: <CalendarOutlined />,
      label: <Link to="/demo/attendance">{t('Attendance')}</Link>,
    },
    {
      key: '/reports',
      icon: <BarChartOutlined />,
      label: <Link to="/demo/reports">{t('Reports')}</Link>,
    },
    {
      key: '/settings',
      icon: <SettingOutlined />,
      label: <Link to="/demo/settings">{t('Settings')}</Link>,
    },
  ]
      ...
      <Layout style={{ margin: '0.25rem 0.25rem' }}>
        ...
        >
          <Flex vertical style={{ height: '100%' }}>
            <Link to="/demo/schools" style={{ textDecoration: 'none' }}>
              <Flex
                vertical
