...
interface VietnameseToEnglishTranslationGameProps {
        ...
        {!isGameStarted ? (
          <div className="text-center bg-glass rounded-xl shadow-lg p-8 py-12 mt-10 w-full max-w-2xl">
            ...
            <p className="text-gray-600 mb-6 text-xl">
              Nhìn nghĩa tiếng Việt và dịch sang từ tiếng Anh. Có{' '}
            ...
            <div className="flex flex-col items-center gap-6">
              <div className="flex flex-col items-center justify-center gap-8 w-full max-w-4xl mx-auto">
                ...
                <div className="text-3xl text-gray-700 text-center">
                  <span className="inline-block bg-indigo-100 text-indigo-700 font-semibold px-6 py-4 rounded-full shadow-lg">
...
interface VietnameseToEnglishTranslationGameActivityProps {
  vocabData: Array<VocabItem>
...
export default VietnameseToEnglishTranslationGame
